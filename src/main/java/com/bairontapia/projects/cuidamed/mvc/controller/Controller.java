...
public class Controller {
    ...
    public void initialize() throws IOException {
        allerElder = FXMLLoader.load(
                Objects.requireNonNull(getClass().getResource("/fxml/allergy_dialog.fxml")));
        dateElder = FXMLLoader.load(
                Objects.requireNonNull(getClass().getResource("/fxml/elder.fxml")));
        surgicalIntervention = FXMLLoader.load(
                Objects.requireNonNull(getClass().getResource("/fxml/surgical_intervention_dialog.fxml")));
        responsible = FXMLLoader.load(
                Objects.requireNonNull(getClass().getResource("/fxml/responsible.fxml")));
        graphic = FXMLLoader.load(
                Objects.requireNonNull(getClass().getResource("/fxml/graphics.fxml")));
        addedElder = FXMLLoader.load(
                Objects.requireNonNull(getClass().getResource(
                        "/fxml/elder_insert.fxml")));
        datePerson = FXMLLoader.load(
                Objects.requireNonNull(getClass().getResource(
                        "/fxml/person.fxml")));
