...
public class ElderView {
  ...
  private void initializeSurgicalInterventionTable() {
    interventionDate.setCellValueFactory(
        e -> new SimpleObjectProperty<>(e.getValue().interventionDate()));
  ...
  private void fillResponsibleFields(final Responsible responsible) {
    ...
    responsibleFullName.setText(
        StringUtils.joinWith(
            " ", responsible.firstName(), responsible.lastName(), responsible.secondLastName()));
