...
public class AllergyDAO implements ReadAndWriteDAO<Allergy, String>,
  ...
  private static final String RELATIVE_PATH_STRING = DirectoryPathUtils.pathBuilder("scripts", "class_queries", "medical_record", "allergy");
