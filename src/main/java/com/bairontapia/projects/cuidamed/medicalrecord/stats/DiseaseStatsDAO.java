...
public class DiseaseStatsDAO implements GenericReadOnlyDAO<DiseaseStats, String> {
  ...
  private static final Path FIND_ALL_QUERY_PATH = Path.of(RELATIVE_PATH_STRING, "disease.sql");
